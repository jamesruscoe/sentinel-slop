...
- Files under template, stub, scaffold or boilerplate directories are copied into other projects by a generator; each variant must stand alone, so duplication between them is the design, not debt. Never propose extracting shared modules across template variants, and never treat imports inside them as this repository's dependencies.
