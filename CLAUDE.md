...
app/
  ...
  Scanning/         framework-free scanning core (see below)
    ...
    Heuristics/     narrating comments, swallowed exceptions, hallucinated deps, placeholders (TODO on a trivial method body = Medium unimplemented-method), near-duplicates, oversized units
